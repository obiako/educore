...
export default {
  data () {
    return {
      ...
      userPoll: '',
      user_info: {
        profile_img: require('@assets/images/profile/pages/page-01.jpg'),
        cover_img: require('@assets/images/profile/pages/page-01.jpg')
      },
      mediaExtensions: { img: ['jpg', 'jpeg', 'png', 'bmp', 'gif', 'exif', 'tiff'], video: ['avi', 'flv', 'wmv', 'mov', 'mp4', '3gp'] },
      suggestedFriends: [
        { name: 'Carissa Dolle', avatar: require('@assets/images/profile/pages/page-01.jpg'),  mutualFriends: 6 },
        { name: 'Liliana Pecor', avatar: require('@assets/images/profile/pages/page-01.jpg'),  mutualFriends: 3 },
        { name: 'Isidra Strunk', avatar: require('@assets/images/profile/pages/page-01.jpg'),  mutualFriends: 2 },
        { name: 'Gerald Licea',  avatar: require('@assets/images/profile/pages/page-01.jpg'),  mutualFriends: 1 },
        { name: 'Kelle Herrick', avatar: require('@assets/images/profile/pages/page-01.jpg'),  mutualFriends: 1 },
        { name: 'Cesar Lee',     avatar: require('@assets/images/profile/pages/page-01.jpg'), mutualFriends: 1 },
        { name: 'John Doe',      avatar: require('@assets/images/profile/pages/page-01.jpg'), mutualFriends: 1 },
        { name: 'Tonia Seabold', avatar: require('@assets/images/profile/pages/page-01.jpg'), mutualFriends: 1 }
      ],
      userLatestPhotos: [
        require('@assets/images/profile/pages/page-01.jpg'),
        require('@assets/images/profile/pages/page-01.jpg'),
        require('@assets/images/profile/pages/page-01.jpg'),
        require('@assets/images/profile/pages/page-01.jpg'),
        require('@assets/images/profile/pages/page-01.jpg'),
      ...
      userPosts: [
        {
          ...
          media      : [{ img: require('@assets/images/profile/pages/page-01.jpg') }],
          likes      : 145,
          comments   : 77,
          usersLiked : [
